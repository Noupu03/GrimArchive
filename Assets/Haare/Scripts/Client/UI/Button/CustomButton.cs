...
namespace Haare.Client.UI
{
        ...
        IPointerEnterHandler
    {
        ...
        public Subject<R3.Unit> Onclicked { get; } = new Subject<R3.Unit>();
        public Subject<R3.Unit> Onhovered { get; }= new Subject<R3.Unit>();
        public Subject<R3.Unit> Onexited { get; }= new Subject<R3.Unit>();
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            if (CheckAndStartCooldown(applyLockNow: true))
                return;
            Onclicked.OnNext(R3.Unit.Default);
        ...
        public void OnPointerExit(PointerEventData eventData)
        {
            ...
            if(!INTERACTIABLE)
                return;
            Onexited.OnNext(R3.Unit.Default);
            if (OPTION_HOVERIMAGE)
            {
                ButtonImage.ChangeCommonImage();
            }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            if(!INTERACTIABLE)
                return;
            Onhovered.OnNext(R3.Unit.Default);
            if(OPTION_HOVERIMAGE){
