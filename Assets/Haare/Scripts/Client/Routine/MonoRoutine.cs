...
namespace Haare.Client.Routine
{
    ...
    public class MonoRoutine : MonoBehaviour ,IRoutine
    {
        ...
        public Subject<R3.Unit> Onupdate { get; protected set; } = new Subject<R3.Unit>();
        public Subject<R3.Unit> OnLateupdate { get; protected set; } = new Subject<R3.Unit>();
        public Subject<R3.Unit> OnFixedupdate { get; protected set; } = new Subject<R3.Unit>();
        ...
        protected virtual void UpdateProcess() {
            Onupdate.OnNext( R3.Unit.Default );
        }
        protected virtual void LateUpdateProcess() {
            OnLateupdate.OnNext( R3.Unit.Default );
        }  
        protected virtual void FixedUpdateProcess() {
            OnFixedupdate.OnNext( R3.Unit.Default );
        }
