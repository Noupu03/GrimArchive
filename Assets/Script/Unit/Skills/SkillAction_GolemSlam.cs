...
// 보스 골렘 공격1(2026-08-24, 기본 구조): 대상 좌표로 일반 공격. GroundAoE와 같은 "좌표에 지연 착탄"
// 흐름을 그대로 쓰되, 파티클 대신 BossGolemHandController가 손을 들어올렸다 내려찍는 연출로 대체한다
// (기획: "파티클 효과는 파티클대신 양손중 하나가 이동하여 내려찍는 모습으로 함").
//
