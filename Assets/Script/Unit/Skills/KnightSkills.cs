...
public class SkillAction_KnightFocusedStab : SkillAction
{
	...
	public override int   HitRange            => 2;
	...
	public override void Execute(Unit unit, Unit target, float minDist)
	{
		...
		BeginAttackCast(
			...
			() =>
			{
				DamageEnemiesInHitboxWithAreaRatio(unit, threat.hitbox, 1.25f);
...
public class SkillAction_KnightShieldBash : SkillAction
{
	...
	public override void Execute(Unit unit, Unit target, float minDist)
	{
		...
		BeginAttackCast(
			...
			() =>
			{
				DamageEnemiesInHitboxWithAreaRatio(unit, threat.hitbox, 0.9f, true, 1f);
